        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://www.instagram.com/TONIQE.guntur"
                target="_blank" rel="noopener noreferrer"
                aria-label="TONIQE on Instagram"
              ...
              <a
                href="https://www.facebook.com/TONIQE.guntur"
                target="_blank" rel="noopener noreferrer"
                aria-label="TONIQE on Facebook"
                className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:border-primary hover:text-primary hover:bg-primary/10 transition-all duration-300"
              >
                <Facebook size={18} />
              </a>
              <a
                href="https://twitter.com/TONIQE_guntur"
                target="_blank" rel="noopener noreferrer"
                aria-label="TONIQE on Twitter"
                className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:border-primary hover:text-primary hover:bg-primary/10 transition-all duration-300"
              >
                <Twitter size={18} />
              </a>
