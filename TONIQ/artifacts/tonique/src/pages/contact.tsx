...
export default function Contact() {
  ...
  const handleLocationClick = () => {
    window.open("https://www.google.com/maps/search/?api=1&query=TONIQE+Restaurant+and+Bar+Guntur", "_blank");
  };
  ...
  const handleEmailClick = () => {
    window.location.href = "mailto:info@TONIQE.com";
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="h-full min-h-[400px] border border-white/10 rounded-sm overflow-hidden relative group">
            <iframe
              ...
              title="TONIQE Restaurant & Bar — Guntur location"
              src="https://maps.google.com/maps?q=TONIQE+Restaurant+and+Bar+Guntur&output=embed&z=17"
              width="100%"
              height="100%"
              ...
              aria-label="Google Maps showing TONIQE Restaurant & Bar in Guntur"
            />
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <a
                ...
                aria-label="Get directions to TONIQE Restaurant & Bar on Google Maps"
        ...
        {/* <div className="border border-primary/30 bg-primary/5 p-12 text-center rounded-sm relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/70 max-w-2xl mx-auto mb-8 font-light">
              Elevate your next corporate gathering, birthday, or celebration with TONIQE's exclusive VIP lounges and custom catering packages.
            </p>
            <Link 
              href="/reservation" 
